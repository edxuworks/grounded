...
// App URL — points to the deployed web platform (override with NEXT_PUBLIC_APP_URL)
const APP_URL = process.env.NEXT_PUBLIC_APP_URL ?? 'https://grounded-cre-app.vercel.app'
